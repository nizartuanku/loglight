...
```
curl -LO https://github.com/nizartuanku/loglight/releases/latest/download/loglight-free-0.2.2-linux-amd64.tar.gz
curl -LO https://github.com/nizartuanku/loglight/releases/latest/download/SHA256SUMS
sha256sum -c SHA256SUMS
tar xzf loglight-free-0.2.2-linux-amd64.tar.gz && cd loglight-0.2.2
./loglight
```
